...
export default function Leaderboard() {
          ...
          setEntries([
            {
              ...
              schoolName: "MA Al-Bahjah Cirebon",
              totalScore: 16,
              currentLevel: 6,
            },
            {
              ...
              schoolName: "MAN 1 Cirebon",
              totalScore: 14,
              currentLevel: 5,
            },
            {
              id: "3",
              studentName: "Muhammad Aqil",
              schoolName: "SMA Islam Terpadu",
              totalScore: 12,
              currentLevel: 4,
            },
            {
  ...
  return (
    <div className="glass-panel" style={{ padding: "24px", marginTop: "32px" }}>
      ...
      >
        <Trophy size={24} color="var(--color-amber-500)" /> Papan Peringkat Literasi Data
        (Real-Time)
      </h3>
