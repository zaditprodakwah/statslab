    ...
    <div className="landing-container" style={{ paddingBottom: "64px" }}>
      <div className="landing-content" style={{ maxWidth: "900px", margin: "0 auto" }}>
        <nav
          ...
          style={{ padding: "24px 0 0", fontSize: "0.875rem", color: "var(--text-secondary)" }}
        >
        ...
        <div className="hero-section text-center" style={{ padding: "32px 0" }}>
          ...
          <h1
            style={{ fontSize: "2.25rem", marginBottom: "16px", color: "var(--color-emerald-700)" }}
          >
            Tentang StatsLab
          </h1>
          <p
        ...
        <div className="glass-panel" style={{ padding: "32px", marginBottom: "32px" }}>
          ...
          <ul style={{ color: "var(--text-secondary)", lineHeight: 1.8, paddingLeft: "20px" }}>
            ...
            <li>
              Uji keterbacaan dan kepraktisan dengan <em>System Usability Scale</em> (SUS).
            </li>
            <li>
              Uji coba skala kecil (<em>small-scale</em>) sebelum implementasi skala besar (
              <em>large-scale</em>).
            </li>
            <li>
        ...
        <div className="glass-panel" style={{ padding: "32px", marginBottom: "32px" }}>
          ...
          <p style={{ color: "var(--text-secondary)", lineHeight: 1.7, marginBottom: "16px" }}>
            <strong>SUS-Extended StatsLab (14 Butir)</strong> — adaptasi dari SUS standar Brooke
            (1996): 10 item standar + 4 item tambahan konteks Islamic EdTech (nilai keislaman,
            ...
            Adjective rating: Poor &lt; 52 &lt; Good &lt; 72 &lt; Excellent &lt; 85 &lt; Best
            Imaginable (Bangor et al., 2009).
          </p>
          <p style={{ color: "var(--text-secondary)", lineHeight: 1.7, marginBottom: "16px" }}>
            ...
            Interpretasi: V ≥ 0.75 = valid (Aiken, 1985). Rekam skor via panel Admin → Validasi
            Pakar.
          </p>
          <p style={{ color: "var(--text-secondary)", lineHeight: 1.7 }}>
          ...
          >
            Referensi: Brooke (1996); Watson &amp; Callingham (2003); Masters (1982); Aiken (1985);
            Bangor et al. (2009); Jöreskog &amp; Sörbom (1996).
          </p>
        </div>
