...
<div align="center">
  <a href="https://statslabmedia.vercel.app">
    <img src="apps/web/public/logo.png" alt="StatsLab Logo" width="140" height="140" />
  </a>
  ...
  <!-- SHIELDS.IO BADGES -->
  <p align="center">
    <a href="https://github.com/zaditprodakwah/statslab/graphs/contributors"><img src="https://img.shields.io/github/contributors/zaditprodakwah/statslab?style=for-the-badge&color=059669" alt="Contributors" /></a>
    <a href="https://github.com/zaditprodakwah/statslab/network/members"><img src="https://img.shields.io/github/forks/zaditprodakwah/statslab?style=for-the-badge&color=059669" alt="Forks" /></a>
    <a href="https://github.com/zaditprodakwah/statslab/stargazers"><img src="https://img.shields.io/github/stars/zaditprodakwah/statslab?style=for-the-badge&color=059669" alt="Stargazers" /></a>
  ...
  <!-- HERO BANNER VISUAL -->
  <p align="center">
    <img src="apps/web/public/social-preview.png" alt="StatsLab Advanced Interactive Dashboard Banner" width="100%" />
  </p>
</div>
...
graph TD
    subgraph Client_Layer["🖥 Client Layer (Browser)"]
        User["Siswa / Guru / Peneliti"]
        UI["React 19 Components (App Router)"]
        State["Zustand Client State Manager"]
        Charts["Recharts 2 Dynamic Data Viz"]
    end

    subgraph Server_Layer["⚡ Next.js 15 Serverless Runtime (Vercel)"]
        API_Sessions["/api/sessions Handler"]
        API_TaskResp["/api/task-responses Handler"]
        API_Export["/api/export (Rasch/CFA/Winsteps)"]
